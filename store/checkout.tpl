    ...
    <div class="ui {if count($WIDGETS_LEFT) && count($WIDGETS_RIGHT) }four wide tablet eight wide computer{elseif count($WIDGETS_LEFT) || count($WIDGETS_RIGHT)}ten wide tablet twelve wide computer{else}sixteen wide{/if} column">
      <div class="ui segment">
        ...
        <table class="ui fixed single line selectable unstackable small padded res table">
          <thead>
            <tr>
              <th style="background: var(--main-color);color: #fff;">{$NAME}</th>
              <th style="background: var(--main-color);color: #fff;">{$OPTIONS}</th>
              <th style="background: var(--main-color);color: #fff;">{$QUANTITY}</th>
              <th style="background: var(--main-color);color: #fff;">{$PRICE}</th>
              <th style="background: var(--main-color);color: #fff;"></th>
            </tr>
          </thead>
          <tbody>
