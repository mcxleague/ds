...
<ol class="breadcrumb">
        ...
        <li{if isset($breadcrumb.active)} class="active"{/if}>{if !isset($breadcrumb.active)}<a class="breadcrumb-link" href="{$breadcrumb.link}">{/if}{$breadcrumb.forum_title}{if !isset($breadcrumb.active)}</a>{/if}
            </li>
        {/foreach}
</ol>
...
<div class="res right floated" style="margin-top: -4rem;">
    {if isset($UNFOLLOW)}
            ...
            <div class="ui row">
                <div class="ui five wide tablet three wide computer column" id="post-sidebar">
                    <center>
                        ...
                        <a href="{$reply.profile}"><img class="ui small circular pfpTopic image" src="{$reply.avatar}"
...
<div class="ui padded segment" id="topic-reply">
    <div class="ui stackable grid">
        <div class="ui row">
            <div class="ui eleven wide tablet thirteen wide computer" style="margin-left: 10px;text-align:center;" id="reply-content">
