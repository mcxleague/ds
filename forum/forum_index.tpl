                ...
                <div class="ui middle aligned stackable grid">
                    ...
                    <div class="centered row forumNode">
                        ...
                        <div class="nine wide column forumNodee">
                            <a class="header forumTitle" href="{$subforum->link}" data-toggle="">{$subforum->forum_title}</a>
                        ...
                        <div class="six wide column mobile hidden">
                            ...
                            <a class="header" href="{$subforum->last_post->link}"
                                data-toggle="">{$subforum->last_post->title}</a>
                            <div class="ui wide popup">
                    ...
                    <div class="centered row forumNode">
                        <div class="one wide column mobile hidden">{if empty($subforum->icon)}<i
                                class="ui large comment forumIcon icon middle aligned"></i>{else}{$subforum->icon}{/if}</div>
                        <div class="fifteen wide column">
                            <a class="header forumTitle" data-toggle="modal" {if isset($subforum->redirect_confirm)}
                                href="#"
