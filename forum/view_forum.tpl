    ...
    <div class="ui centered row">
        ...
        <div
            ...
            <table class="ui fixed single line selectable unstackable small padded res table card-body" id="subforums-table">
                <thead>
                    <tr>
                        <th class="nine wide" style="background:#131313;box-shadow:var(--border-box);color:#fff;padding:20px;text-transform:uppercase;">
                            <h4>{$SUBFORUM_LANGUAGE}</h4>
                        </th>
                        <th class="seven wide" style="background:#131313;box-shadow:var(--border-box);color:#fff;padding:20px;text-transform:uppercase;">
                        <h4>Author</h4>
                        </th>
                    </tr>
                </thead>
            ...
            <table class="ui fixed single line selectable unstackable small padded res table card-body" id="sticky-threads">
                <thead>
                    <tr>
                        <th class="eight wide" style="background:#131313;box-shadow:var(--border-box);color:#fff;padding:20px;text-transform:uppercase;">
                            <h4>{$STICKY_TOPICS}</h4>
                        </th>
                        <th class="three wide" style="background:#131313;box-shadow:var(--border-box);color:#fff;padding:20px;text-transform:uppercase;">
                        <h4>Stats</h4>
                        </th>
                        <th class="five wide" style="background:#131313;box-shadow:var(--border-box);color:#fff;padding:20px;text-transform:uppercase;">
                        <h4>Author</h4>
                        </th>
                    </tr>
                </thead>
